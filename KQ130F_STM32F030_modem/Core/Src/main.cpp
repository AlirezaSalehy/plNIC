...
osThreadId plNICHandleTaskHandle;
uint32_t plNICHandleTaskBuffer[ 256 ];
osStaticThreadDef_t plNICHandleTaskControlBlock;
osThreadId testCaseTaskHandle;
uint32_t testCaseTaskBuffer[ 256 ];
osStaticThreadDef_t testCaseTaskControlBlock;
/* USER CODE BEGIN PV */
...
extern void StartplNICHandleTask(void const * argument);
extern void StartTestCaseTask(void const * argument);
